...
public class Admin extends javax.swing.JFrame {
   ...
   public Admin(Account t) throws UnsupportedLookAndFeelException {
    ...
    this.currentAcc = t;
    logger.info("Đăng nhập Admin thành công với user: " + t.getUser());

    ProductForm pf = new ProductForm();
    MainContent.add(pf).setVisible(true);

    DefaultColor = new Color(51, 102, 255);
    ClickedColor = new Color(30, 80, 200);
    ...
    // ➕ Thêm dòng này để xử lý click btnLog
    btnLog.addActionListener(e -> {
        LogViewerManual logViewer = new LogViewerManual(this, true);
    ...
    private void initComponents() {
        ...
        SanPham.setBackground(new java.awt.Color(51, 102, 255));
        ...
        NhaCungCap.setBackground(new java.awt.Color(51, 102, 255));
        ...
        TonKho.setBackground(new java.awt.Color(51, 102, 255));
        ...
        TaiKhoan1.setBackground(new java.awt.Color(51, 102, 255));
        ...
        ThongKe.setBackground(new java.awt.Color(51, 102, 255));
        ...
        btnLog.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        btnLog.setForeground(new java.awt.Color(255, 255, 255));
        btnLog.setText("LỊCH SỬ HOẠT ĐỘNG");
        NavbarMenu.add(btnLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, -1, -1));
