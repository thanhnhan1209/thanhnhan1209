...
public class UpdatePhieuNhap extends javax.swing.JDialog {
    ...
    private void displayInfo() {
        ...
        txtNguoiTao.setText((String) AccountDAO.getInstance().selectById(phieunhap.getNguoiTao()).getUser());
...
PhieuNhap pn = new PhieuNhap(
    arrNcc.get(cboNhaCungCap.getSelectedIndex()).getMaNhaCungCap(),  // mã nhà cung cấp
    phieunhap.getMaPhieu(),                                         // mã phiếu
    sqlTimestamp,                                                   // thời gian tạo
    txtNguoiTao.getText(),                                          // người tạo
    tinhTongTien()                                                  // tổng tiền
);            try {
    ...
    private void addProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addProductActionPerformed
        ...
        if (i_row == -1) {
            ...
            if (mtl != null) {
                ...
                ChiTietPhieu ctp = new ChiTietPhieu(phieunhap.getMaPhieu(), mt.getMaSP(), soluong, mt.getGia());
                CTPhieu.add(ctp);
            }
            loadDataToTableNhapHang();
            textTongTien.setText(formatter.format(tinhTongTien()) + "đ");
