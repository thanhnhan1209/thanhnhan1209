...
public class CTThongKe extends javax.swing.JDialog {
    ...
    public CTThongKe(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        PhieuNhap pn = this.parent.findPhieu();
    ...
    public void loadDataToTableProduct() {
        try {
            ...
            if (check.contains("PX")) {
                ArrayList<ChiTietPhieu> CTPhieu = (ArrayList<ChiTietPhieu>) ChiTietPhieuXuatDAO.getInstance().selectAll(check);
    ...
    public ArrayList<Phieu> getPhieuAll() {
        ...
        ArrayList<PhieuNhap> conten1 = (ArrayList<PhieuNhap>) PhieuNhapDAO.getInstance().selectAll();
        ArrayList<PhieuXuat> conten2 = (ArrayList<PhieuXuat>) PhieuXuatDAO.getInstance().selectAll();
        for (PhieuNhap phieuNhap : conten1) {
            String maPhieu = phieuNhap.getMaPhieu();
            Timestamp thoiGianTao = (Timestamp) phieuNhap.getThoiGianTao();
