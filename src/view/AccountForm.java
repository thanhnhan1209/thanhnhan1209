...
public class AccountForm extends javax.swing.JInternalFrame {
    ...
    private ArrayList<Account> accounts = (ArrayList<Account>) AccountDAO.getInstance().selectAll();
            ...
            if (select.getRole().equals("Admin")) {
                ...
                if (checkVl == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        loadDataToTable((ArrayList<Account>) AccountDAO.getInstance().selectAll());
                    } catch (Exception e) {
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (check == JOptionPane.YES_OPTION) {
                ...
                if (textct.equals("")) {
                    ...
                    accounts = (ArrayList<Account>) AccountDAO.getInstance().selectAll();
                    loadDataToTable(accounts);
                }
            }
        }
